# Generated by Powerlevel10k configuration wizard on 2024-08-16 at 18:11 PDT.
...
# flat tails, 2 lines, disconnected, full frame, darkest-ornaments, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=45
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=216
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=183
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=0
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=81
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=39
  ...
  #############[ rbenv: ruby version from rbenv (https://github.com/rbenv/rbenv) ]##############
  # Rbenv color.
  typeset -g POWERLEVEL9K_RBENV_FOREGROUND=15
  typeset -g POWERLEVEL9K_RBENV_BACKGROUND=13
